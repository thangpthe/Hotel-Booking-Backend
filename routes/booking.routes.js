...
import { bookRoom, checkRoomAvailability, deleteBooking, getBookedDates, getHotelBookings, getUserBookings, stripePayment, updateBooking } from "../controllers/booking.controller.js";
...
bookingRouter.get("/booked-dates/:roomId", getBookedDates); // Public - lấy ngày đã đặt cho calendar
